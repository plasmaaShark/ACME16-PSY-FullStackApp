...
def generate_goal_feedback(scores, labels, current_title, is_overall=False):
    ...
    feedback_templates = {
        "Goal Thinking": {
        "high": "Your current level of thinking about this goal is high. This is good. This indicates your goal is important to you and that you are committed to making this goal happen. Goals are more motivating, more likely to lead to effective action, when they are on our mind, when we are thinking about them frequently.",
